  ...
  return (
    <div className="tracking-tabs d-flex mx-auto shadow align-items-center">
      <div className={selectedTabNum === 1 ? "tab text-center active": "tab text-center"} onClick={()=>setSelectedTabNum(1)}>
        ...
        <p className="mb-0 mt-2">Recipient Request</p>
      </div>
      <div className={selectedTabNum === 2 ? "tab text-center active": "tab text-center"} onClick={()=>setSelectedTabNum(2)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={20}
          height={20}
        ...
        <p className="mb-0 mt-2">Donor Agreement</p>
      </div>
      <div className={selectedTabNum === 3 ? "tab text-center active": "tab text-center"} onClick={()=>setSelectedTabNum(3)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={20}
          height={20}
        ...
        <p className="mb-0 mt-2">Compatibility Test</p>
      </div>
      <div className={selectedTabNum === 4 ? "tab text-center active": "tab text-center"} onClick={()=>setSelectedTabNum(4)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={20}
          height={20}
        ...
        <p className="mb-0 mt-2">Government Permission</p>
      </div>
      <div className={selectedTabNum === 5 ? "tab text-center active": "tab text-center"} onClick={()=>setSelectedTabNum(5)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={20}
          height={20}
        ...
        <p className="mb-0 mt-2">Final Checks</p>
      </div>
    </div>
  );
};
